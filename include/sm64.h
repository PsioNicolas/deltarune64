...
// Disable turning around
#define ACT_TURNING_AROUND             ACT_IDLE   // (0x043 | ACT_FLAG_MOVING)
#define ACT_FINISH_TURNING_AROUND      0x00000444 // (0x044 | ACT_FLAG_MOVING)
// Disable braking
#define ACT_BRAKING                    ACT_IDLE   // (0x045 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON)
